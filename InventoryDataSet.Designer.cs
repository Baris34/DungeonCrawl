...
namespace DungeonCrawl {
    ...
    public partial class InventoryDataSet : global::System.Data.DataSet {
        ...
        public partial class InventoryDataTable : global::System.Data.TypedTableBase<InventoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public InventoryRow AddInventoryRow(string Name, int Damage, int Block) {
        ...
        public partial class InventoryRow : global::System.Data.DataRow {
            ...
            public int Block {
                get {
                    try {
                        return ((int)(this[this.tableInventory.BlockColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Block\' in table \'Inventory\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableInventory.BlockColumn] = value;
                }
            }
            ...
            public bool IsBlockNull() {
                return this.IsNull(this.tableInventory.BlockColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetBlockNull() {
                this[this.tableInventory.BlockColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace DungeonCrawl.InventoryDataSetTableAdapters {
    ...
    public partial class InventoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Inventory` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Na" +
                "me` = ?)) AND ((? = 1 AND `Damage` IS NULL) OR (`Damage` = ?)) AND ((? = 1 AND `" +
                "Block` IS NULL) OR (`Block` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Inventory` (`Name`, `Damage`, `Block`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Inventory` SET `Name` = ?, `Damage` = ?, `Block` = ? WHERE ((`ID` = ?) AN" +
                "D ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Damage` IS NULL)" +
                " OR (`Damage` = ?)) AND ((? = 1 AND `Block` IS NULL) OR (`Block` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Damage, Block FROM Inventory";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, global::System.Nullable<int> Original_Damage, global::System.Nullable<int> Original_Block) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Damage, global::System.Nullable<int> Block) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Damage, global::System.Nullable<int> Block, int Original_ID, string Original_Name, global::System.Nullable<int> Original_Damage, global::System.Nullable<int> Original_Block) {
            if ((Name == null)) {
            ...
            if ((Original_Block.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_Block.Value));
            }
            else {
